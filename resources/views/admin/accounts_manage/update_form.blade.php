<div class="panel panel-primary">
  ...
  <thead>
    <tr>
          <th class="text-center" colspan="4"><span style="color:#FF4500;">到期时间为：2019-2-1 9:42:57</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <th class="text-center" colspan="4"><button type="button" class="btn btn-primary" id="go_back">返回列表</button><button type="button" class="btn btn-info">&nbsp;&nbsp;&nbsp;&nbsp;修改&nbsp;&nbsp;&nbsp;&nbsp;</button></th>
    </tr>
  </tbody>
</table>
</div>
